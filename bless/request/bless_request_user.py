...
class BlessUserSchema(Schema):
    ...
    public_key_sig = fields.Str(required=False)
...
class BlessUserRequest:
    def __init__(self, bastion_ips, bastion_user, bastion_user_ip, command, public_key_to_sign,
                 remote_usernames, kmsauth_token=None, public_key_sig=None):
        """
        ...
        :param str public_key_sig: An optional public key signature
        """
